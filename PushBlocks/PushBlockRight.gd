...
func _physics_process(delta):
	...
	if on_left and Input.get_action_strength("down") == 1 and ray.is_colliding() and !right.is_colliding() and pusher.floored:
		target_pos = 1
	if on_right and Input.get_action_strength("up") == 1 and ray.is_colliding() and !left.is_colliding() and pusher.floored:
		target_pos = -1
